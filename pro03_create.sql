...
create table tbl_notice(idx int(20) auto_increment primary key, title varchar(100) not null, content varchar(1000), author varchar(20), file1 varchar(200), regdate datetime default current_timestamp, readcnt int(20) default 0);
create table tbl_spot(mname varchar(20) primary key, cate varchar(6), addr varchar(300), phone varchar(13), comm varchar(1000), pic varchar(200), local_num varchar(6));
create table tbl_show(sname varchar(20) primary key, cate varchar(6), addr varchar(300), phone varchar(13), comm varchar(1000), pic varchar(200));
...
create table tbl_exp(ename varchar(20) primary key, cate varchar(6), addr varchar(300), phone varchar(13), comm varchar(1000), pic varchar(200));
